...
public class MoveableCharacter : MonoBehaviour
{
    ...
    protected bool IsOnSlope(Rigidbody _rb, float MaxSlopeAngle, bool isGrounded, CapsuleCollider _Collider)
    {
    ...
    protected bool CheckIfGrounded(Transform GroundCheckPos, float GroundCheckRadius, LayerMask WhatIsGround)
    {
